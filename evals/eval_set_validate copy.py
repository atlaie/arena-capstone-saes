...
# models = ['gemma-2-2b-it','gemma-2-2b-it-wmdp/gemma-2-2b-it-noQuant']
...
model_1 = AutoModelForCausalLM.from_pretrained('../gemma-2-2b-it-wmdp/gemma-2-2b-it_LoRa_synthetic-dataset')
# %%
model_1
